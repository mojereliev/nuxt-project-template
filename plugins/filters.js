...
Vue.filter('pluralize', (numberOrigin, words) => {
  let number = Math.abs(numberOrigin);
  number %= 100;
...
Vue.filter('toHHMMSS', (secondsValueOrigin) => {
  const secondsValue = parseInt(secondsValueOrigin, 10); // don't forget the second param
